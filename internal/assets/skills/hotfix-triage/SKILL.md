...
2. **Task & Lease Reservation:**
   - When a ForgeSpec task exists, run the canonical implementer lifecycle (claim, attempt-bound file leases, heartbeat, completion order, mandatory cleanup). Keep authority tokens only in live context.
