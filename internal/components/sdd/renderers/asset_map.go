...
var adapterAssetMaps = map[TargetID]AdapterAssetMap{
	...
	"gemini":      {Target: "gemini", WorkflowRoot: ".gemini", SkillsRoot: ".gemini/skills", AgentsRoot: ".gemini/agents", OverlayRoot: ".gemini/overlays", QualityRoot: ".gemini/quality", ManifestRoot: ".cortex-ia", ModelRoot: ".cortex-ia/models", PermissionRoot: ".cortex-ia/permissions", NativeProfiles: map[string]bool{"portable-sequential": true, "portable-flat": true, "native-advanced": true}},
	"cursor":      {Target: "cursor", WorkflowRoot: ".cursor", SkillsRoot: ".cursor/skills", AgentsRoot: ".cursor/agents", OverlayRoot: ".cursor/overlays", QualityRoot: ".cursor/quality", ManifestRoot: ".cortex-ia", ModelRoot: ".cortex-ia/models", PermissionRoot: ".cortex-ia/permissions", NativeProfiles: map[string]bool{"portable-sequential": true, "portable-flat": true, "native-advanced": true}},
	...
	"windsurf":    {Target: "windsurf", WorkflowRoot: ".codeium/windsurf", SkillsRoot: ".codeium/windsurf/skills", AgentsRoot: ".codeium/windsurf/agents", OverlayRoot: ".codeium/windsurf/overlays", QualityRoot: ".codeium/windsurf/quality", ManifestRoot: ".cortex-ia", ModelRoot: ".cortex-ia/models", PermissionRoot: ".cortex-ia/permissions", NativeProfiles: map[string]bool{"portable-sequential": true, "portable-flat": true, "native-advanced": true}},
	"antigravity": {Target: "antigravity", WorkflowRoot: ".gemini/antigravity", SkillsRoot: ".gemini/antigravity/skills", AgentsRoot: ".gemini/antigravity/agents", OverlayRoot: ".gemini/antigravity/overlays", QualityRoot: ".gemini/antigravity/quality", ManifestRoot: ".cortex-ia", ModelRoot: ".cortex-ia/models", PermissionRoot: ".cortex-ia/permissions", NativeProfiles: map[string]bool{"portable-sequential": true, "portable-flat": true, "native-advanced": true}},
	"kilocode":    {Target: "kilocode", WorkflowRoot: ".config/kilo", SkillsRoot: ".config/kilo/skills", AgentsRoot: ".config/kilo/agents", CommandsRoot: ".config/kilo/commands", OverlayRoot: ".config/kilo/overlays", QualityRoot: ".config/kilo/quality", ManifestRoot: ".cortex-ia", ModelRoot: ".cortex-ia/models", PermissionRoot: ".cortex-ia/permissions", SlashCommands: true, NativeProfiles: map[string]bool{"portable-sequential": true, "portable-flat": true, "native-advanced": true}},
	"kimi":        {Target: "kimi", WorkflowRoot: ".kimi", SkillsRoot: ".kimi/skills", AgentsRoot: ".kimi/agents/roles", OverlayRoot: ".kimi/overlays", QualityRoot: ".kimi/quality", ManifestRoot: ".cortex-ia", ModelRoot: ".cortex-ia/models", PermissionRoot: ".cortex-ia/permissions", NativeProfiles: map[string]bool{"portable-sequential": true, "portable-flat": true, "native-advanced": true}},
	"kiro":        {Target: "kiro", WorkflowRoot: ".kiro", SkillsRoot: ".kiro/skills", AgentsRoot: ".kiro/agents", OverlayRoot: ".kiro/overlays", QualityRoot: ".kiro/quality", ManifestRoot: ".cortex-ia", ModelRoot: ".cortex-ia/models", PermissionRoot: ".cortex-ia/permissions", ExternalConfigRoot: "%APPDATA%/kiro/User", NativeProfiles: map[string]bool{"portable-sequential": true, "portable-flat": true}},
	"qwen":        {Target: "qwen", WorkflowRoot: ".qwen", SkillsRoot: ".qwen/skills", AgentsRoot: ".qwen/agents", CommandsRoot: ".qwen/commands", OverlayRoot: ".qwen/overlays", QualityRoot: ".qwen/quality", ManifestRoot: ".cortex-ia", ModelRoot: ".cortex-ia/models", PermissionRoot: ".cortex-ia/permissions", SlashCommands: true, NativeProfiles: map[string]bool{"portable-sequential": true, "portable-flat": true, "native-advanced": true}},
}
...
func (m AdapterAssetMap) ValidateProfile(profile string) error {
	...
	if m.Target == "kiro" && profile == "native-advanced" {
		return nil // deterministic sequential degradation; never fake native support
	}
	return nil
}
