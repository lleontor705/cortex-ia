...
# cortex-ia — Branch & PR Skill

## When to Use

Load this skill whenever you need to:
- Create a branch for a new fix or feature
- Open a pull request on [lleontor705/cortex-ia](https://github.com/lleontor705/cortex-ia)
...
1. Confirm the issue has status:approved
   gh issue view <N> --repo lleontor705/cortex-ia
...
```bash
gh pr checks --repo lleontor705/cortex-ia <PR-number>
gh pr view --repo lleontor705/cortex-ia <PR-number>
```

### Add a Label

```bash
gh pr edit <PR-number> --repo lleontor705/cortex-ia --add-label "type:bug"
```
