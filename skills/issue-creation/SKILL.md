...
# cortex-ia — Issue Creation Skill

## When to Use

Load this skill whenever you need to:
- Report a bug in `cortex-ia`
- Request a new feature or enhancement
- Open any GitHub issue on the [lleontor705/cortex-ia](https://github.com/lleontor705/cortex-ia) repository
...
4. **Questions go to Discussions** — use [GitHub Discussions](https://github.com/lleontor705/cortex-ia/discussions), NOT issues, for questions and general conversation.
...
1. Search existing issues → confirm it's not a duplicate
   https://github.com/lleontor705/cortex-ia/issues
...
```
https://github.com/lleontor705/cortex-ia/issues/new?template=bug_report.yml
```
...
|-------|-------------|
| Pre-flight Checklist | Confirm no duplicate exists; confirm PR-approval understanding |
| Affected Area | Which area of `cortex-ia` this feature affects |
| Problem Statement | Describe the problem this feature solves |
| Proposed Solution | Specific description — include example `cortex-ia` command/output if relevant |
...
Or open the web form directly:
```
https://github.com/lleontor705/cortex-ia/issues/new?template=feature_request.yml
```
...
```bash
# Search open issues
gh issue list --repo lleontor705/cortex-ia --state open --search "your keywords"

# Search all issues including closed
gh issue list --repo lleontor705/cortex-ia --state all --search "your keywords"
```
...
```bash
gh issue view <number> --repo lleontor705/cortex-ia
```
